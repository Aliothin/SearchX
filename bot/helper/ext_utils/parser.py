...
def unified(url: str) -> str:
    ...
    if info_parsed["error"]:
        raise DDLException(f"ERROR! {info_parsed['error_message']}")
...
def udrive(url: str) -> str:
    ...
    try:
        ...
        raise DDLException("ERROR! File Not Found or User rate exceeded !!")
    ...
    if directLogin==False:
        ...
        try:
            ...
            if (len(SHAREDRIVE_PHPCKS)>0 and directLogin!=False):
                ...
                raise DDLException('Direct Login is not there and you have not provided PHPCKS cookie value!!')        
